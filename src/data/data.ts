export const DATA = [
  ...
  },
  {
    ...
    likes: '4125',
    requirements:
      'Pothos can tolerate a wide range of light conditions, from low to bright indirect light. Water when the top inch of soil is dry and allow excess water to drain away.',
  },
  {
    id: '6Yh2N1KdVmZx',
  ...
  {
    id: '9Gj7B0CfLaRt',
    image: 'https://i.postimg.cc/pTj0sX06/4-STRELITZIA-BIRD-OF-PARADISE-1-removebg-preview-1.png',
    ...
    likes: '2118',
    requirements:
      'Bird of Paradise requires bright, indirect light and consistently moist soil. They also benefit from regular misting and should be fertilized monthly during the growing season.',
  },
  {
    id: '2Tc5E4QpXuMo',
    image:
    ...
    likes: '2975',
    requirements:
      'Rubber plants prefer bright, indirect light but can also tolerate low light conditions. Water when the top inch of soil is dry and mist the leaves occasionally to increase humidity.',
  },
  {
    id: '5Zm1W8VrPyNk',
  ...
  },
  {
    ...
    likes: '2386',
    requirements:
      'Spider plants prefer bright, indirect light but can also tolerate low light conditions. Water when the top inch of soil is dry and allow excess water to drain away.',
  },
  {
    id: '7Qs2Z9EjKbMh',
    ...
    likes: '2841',
    requirements:
      'Philodendron Brasil prefers bright, indirect light but can also tolerate low light conditions. Water when the top inch of soil is dry and allow excess water to drain away.',
  },
  {
    id: '3Lc5G6FtVnKu',
    ...
    likes: '2278',
    requirements:
      'Pilea Peperomioides prefers bright, indirect light and well-draining soil. Water when the top inch of soil is dry and mist the leaves occasionally to increase humidity.',
  },
  {
    id: '1Tm9X0NpRyOe',
    ...
    likes: '3985',
    requirements:
      'Monstera Deliciosa prefers bright, indirect light and well-draining soil. Water when the top inch of soil is dry and mist the leaves occasionally to increase humidity. Provide support for the plant as it grows, as it can become quite large.',
  },
  {
    id: '6Bv4K7YjHgUi',
    image: 'https://i.postimg.cc/g2cTGpJx/1-Ficus-Lybata-6.jpg',
  ...
  {
    id: '9Dx3F2PqEaVl',
    image: 'https://i.postimg.cc/hPVXKFwR/8b0ec882-5de9-5049-95f1-fbb1059c22bb.jpg',
    title: 'Boston Fern',
    author: 'plant_crazy',
    description:
      "Boston Fern, also known as Nephrolepis exaltata, is a classic houseplant with long, delicate fronds that arch gracefully. Native to tropical regions worldwide, it's a great choice for those who want to add a touch of greenery to their home.",
    location: 'Tropical regions worldwide',
    likes: '1765',
    requirements:
      'Boston Ferns prefer bright, indirect light and high humidity. Water regularly and mist the leaves often to increase humidity. They also benefit from occasional fertilizer and repotting.',
  },
  {
    id: '2Sf1N6GkYbWu',
